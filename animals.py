...
class Buffalo(Animal):
    ...
    def info(cls):
        ...
        hp = int(round(clamp(random.gauss(350, 15), 300, 400)))
        attack = int(round(clamp(random.gauss(38, 3), 28, 48)))
        defense = int(round(clamp(random.gauss(70, 5), 55, 85)))
        hunger = 20
        speed = round(clamp(random.gauss(3.0, 0.2), 2.0, 4.0), 2)
        sight = int(round(clamp(random.gauss(130, 10), 100, 160)))
...
class Gazelle(Animal):
    ...
    def info(cls):
        ...
        hp = int(round(clamp(random.gauss(80, 5), 65, 95)))
        attack = int(round(clamp(random.gauss(8, 1), 5, 11)))
        defense = int(round(clamp(random.gauss(15, 2), 10, 20)))
        hunger = 20
        speed = round(clamp(random.gauss(6.0, 0.4), 4.5, 7.5), 2)
        sight = int(round(clamp(random.gauss(110, 8), 90, 130)))
...
class Hyena(Animal):
    ...
    def info(cls):
        ...
        hp = int(round(clamp(random.gauss(120, 8), 100, 140)))
        attack = int(round(clamp(random.gauss(30, 2), 24, 36)))
        defense = int(round(clamp(random.gauss(25, 2), 19, 31)))
        hunger = 60
        speed = round(clamp(random.gauss(4.0, 0.2), 3.0, 5.0), 2)
        sight = int(round(clamp(random.gauss(140, 10), 110, 170)))
...
class Lion(Animal):
    ...
    def info(cls):
        ...
        hp = int(round(clamp(random.gauss(200, 10), 170, 230)))
        attack = int(round(clamp(random.gauss(40, 3), 30, 50)))
        defense = int(round(clamp(random.gauss(50, 4), 40, 60)))
        hunger = 50
        speed = round(clamp(random.gauss(4.0, 0.2), 3.2, 4.8), 2)
        sight = int(round(clamp(random.gauss(150, 10), 120, 180)))
...
class Zebra(Animal):
    ...
    def info(cls):
        ...
        hp = int(round(clamp(random.gauss(130, 7), 110, 150)))
        attack = int(round(clamp(random.gauss(20, 2), 15, 25)))
        defense = int(round(clamp(random.gauss(30, 3), 20, 40)))
        hunger = 25
        speed = round(clamp(random.gauss(5.0, 0.3), 4.0, 6.0), 2)
        sight = int(round(clamp(random.gauss(200, 15), 160, 240)))
...
class Elephant(Animal):
    ...
    def info(cls):
        ...
        hp = int(round(clamp(random.gauss(700, 30), 600, 800)))
        attack = int(round(clamp(random.gauss(55, 4), 45, 65)))
        defense = int(round(clamp(random.gauss(120, 8), 95, 145)))
        hunger = 20
        speed = round(clamp(random.gauss(2.0, 0.1), 1.5, 2.5), 2)
        sight = int(round(clamp(random.gauss(120, 8), 90, 150)))
